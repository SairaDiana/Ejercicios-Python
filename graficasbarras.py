...
plot1= list(prueba)
plt.barh(y_pos, plot1, align='center', alpha=0.5)
plt.yticks(y_pos, keys, rotation = 0, fontsize = 10, ha= 'left')
plt.xlabel('VOTOS')
...
keys2 = list(name2)
y_pos2 = np.arange(len(keys2))
plot2= list(prueba2)
plt.barh(y_pos2, plot2, align='center', color='blue', alpha=0.3)
plt.yticks(y_pos2, keys2, rotation = 0, fontsize = 6, ha= 'left')
plt.xlabel('VOTOS')
plt.ylabel('PELICULAS')
plt.title('TOP 20')
plt.tight_layout()
